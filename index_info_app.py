...
index_name = st.sidebar.text_input('인덱스명', value="food_index").lower()

field_name = st.sidebar.text_input('필드명', value="식품명")

match_name = st.sidebar.text_input('조회하려는 내용', value="된장찌개")
